...
int create_udp_inet(void){
    ...
    /*Пытался "занулить" структуру с адрессом клиента и присвоить ему имя через бинд.Всё равно сервер
    ...
    /*Сервер отправляет ответ на неверный адресс , поэтому клиент остаётся в постоянном ожидание*/
